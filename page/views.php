<?php 
    ...
    $info = $conn->prepare("SELECT * FROM product_merchant WHERE ID = :id AND status_product = 'تم قبول'");
    ...
    if($info->rowCount() != 1){
        ...
        // here show name store
        $name_store = $conn->prepare("SELECT * FROM signup_merchant WHERE id_user = :id");
        $name_store->bindParam("id",$info_show['id_user']);
        $name_store->execute();
        $name_store = $name_store->fetch(PDO::FETCH_ASSOC);
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    ...
                                    <?php foreach($images AS $show): ?>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="<?= $show['file_src']; ?>" style="height: 110px;margin: 2rem 0;" alt="Product">
                                            </a>
                                        </div>
                                    <?php endforeach; ?>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card border-0 shadow-lg p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            ...
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item">
                                    <h6 class="cairo">البائع:</h6>
                                </li>
                                <li class="list-inline-item">
                                    <a href="javascript:void(1);" class="text-dark"><strong><?php echo $name_store['name_store']; ?></strong></a>
                                </li>
                            </ul>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <a href="add_cart.php?cart=<?php echo $id; ?>" class="btn btn-dark cairo">الاضافة الي عربة التسوق</a>
                                    </div>
                                    <div class="col d-grid">
                                        <a href="favourites.php?fav=<?php echo $id; ?>" class="btn btn-dark cairo">الاضافة للمفضلات</a>
                                    </div>
                                </div>
                            </form>
