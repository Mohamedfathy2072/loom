      ...
      if(isset($_POST['btn'])):
        // here filter data
          ...
          if(empty($title) || empty($price) || empty($categorys) || empty($description)):
            ...
            // here edit data
            $edit = $conn->prepare("UPDATE product_merchant SET title = :title,price = :price,category=:category,size_title=:size_title,size=:size,description=:description,description_api = :description_api,status_product = 'في الانتظار',price_coupon = :price_copun,quantity = :quantity,rt_product = :rt_product,grenti = :grenti WHERE ID = :id AND id_user = :id_user");
                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-company">السعر منتج</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="basic-default-number" placeholder="200 ر.س" name="price" value="<?php echo $get_data->price; ?>">
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="basic-default-number" placeholder="120 ر.س" name="price_copun" value="<?php echo $get_data->price_coupon; ?>">
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="basic-default-number" placeholder="30,غير محدود" name="quantity" value="<?php echo $get_data->quantity; ?>">
                            </div>
                          </div>
                            ...
                            <div class="col-sm-10">
                              ...
                              <div class="col-md">
                                ...
                                <div class="col-sm-12 mt-3" id="roleinput" style="display: block;">
                                  <input type="text" class="form-control mb-3" placeholder="الاسم الوان" name="name_color" value="<?php echo $get_data->size_title; ?>">
                                  <input type="text" class="form-control" placeholder="small,large,xl,xxl,42,43,44,45,plus,lite" name="size" value="<?php echo $get_data->size; ?>">
                                </div>
