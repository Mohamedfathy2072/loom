...
if(!isset($_SESSION['username_admins']) || !isset($_SESSION['email_admins']) || !isset($_SESSION['password_admins']) || !isset($_SESSION['id_admins'])):
...
if(isset($_POST['login'])):
  ...
  if(empty($email) || empty($password)){
    ...
    $login = $conn->prepare("UPDATE member_admin SET email = :email, password = :password WHERE id = :id");
    $login->bindParam("email",$email);
    $login->bindParam("password",$password);
    $login->bindParam("id",$_SESSION['id_admins']);
    if($login->execute()){
     // here if secssfuly update data
     $_SESSION['email_admins'] = $email;
     $_SESSION['password_admins'] = $password;
              ...
              <form id="formAuthentication" class="mb-3" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    value="<?php echo $_SESSION['username_admins']; ?>"
                    autofocus
                    disabled
                  />
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input
                    ...
                    value="<?php echo $_SESSION['email_admins']; ?>"
                    autofocus
                    required
                  />
                </div>
