                        ...
                        <td>
                          ...
                          <div class="dropdown">
                            ...
                            <?php if(!empty($_SESSION['role_edit']) && $_SESSION['role_edit'] == "التعديل"): ?>
                              <a class="dropdown-item text-primary" href="edit_slider.php?id=<?php echo $show_data['id']; ?>"><i class="bx bxs-edit me-1"></i>تعديل</a>
                              <?php endif;
                                if(!empty($_SESSION['role_delete']) && $_SESSION['role_delete'] == "الحذف"):
                              ?>
                              <a class="dropdown-item text-danger" href="trash/delete_slider.php?id=<?php echo $show_data['id']; ?>"><i class="bx bx-trash me-1"></i>الحذف</a>
                              <?php endif; ?>
                            </div>
