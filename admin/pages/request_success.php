<?php
     ...
     require "../../inc/config/db.php";
       ...
       $data = $conn->query("SELECT * FROM `product_merchant` INNER JOIN category ON product_merchant.category = category.id WHERE status_product = 'تم قبول' ORDER BY product_merchant.ID DESC");
   ?>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="text-align: right;">
                              <a class="dropdown-item text-primary" href="../../page/views.php?id=<?php echo $show_data['ID']; ?>"><i class='bx bxs-message-rounded-error'></i>مشاهدت المنتج</a>
