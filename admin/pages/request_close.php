<?php
     ...
     require "../../inc/config/db.php";
       ...
       $data = $conn->query("SELECT * FROM `product_merchant` INNER JOIN category ON product_merchant.category = category.id WHERE status_product = 'مرفوض' ORDER BY product_merchant.ID DESC");
   ?>
