<?php
     ...
     if(isset($_POST['btn'])):
       // here filter data
         ...
         if(empty($first_name) || empty($last_name) || empty($phone_number) || empty($gender) || empty($status)){
            echo "<script>alert('رجاء لا ترسل بيانات فارغة')</script>";
         }else{
            // here insert data
            $edit = $conn->prepare("UPDATE member SET first_name=:first_name,last_name=:last_name ,phone_number = :phone_number,gender = :gender,status = :status WHERE id = :id");
                         ...
                         <div class="row mb-3">
                           ...
                           <div class="col-md">
                                ...
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="ذكر" checked>
                                  <label class="form-check-label" for="inlineRadio1">ذكر</label>
                                </div>

                                <div class="form-check form-check-inline mt-3">
                                  <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="أنثى">
