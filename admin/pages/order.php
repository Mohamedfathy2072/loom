          ...
          <div class="row">
            ...
            <div class="card">
                <h5 class="card-header">
                  ...
                  <a href="others/order_close.php" class="btn btn-danger">
                    طلبات الملغية
                  </a>
                  
                  <a href="others/order_rt_secondary.php" class="btn btn-warning text-dark">
                    طلبات الاسترجاع
                  </a> 

                  <a href="others/order_grenti.php" class="btn btn-info text-dark">
                    طلبات الضمان
                  </a> 
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="text-align: right;">
                              ...
                              <a class="dropdown-item text-secondary" href="javascript:void(0);"> <i class="bx bxs-file-pdf me-1"></i>طباعة</a>
