...
$from = "setpassword@loomshope.com";
$subject = "اعادة تعين كلمة السر خاصة بك";
          	...
          	<table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
          		<tr>
          			<td class='logo' style='text-align: center;'>
			            <h1><a href='https://loomshope.com/'>اعادة التعين كلمة المرور</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
            	...
            	<tr>
            		<td>
            			<div class='text' style='padding: 0 2.5em; text-align: right;'>
            				<h2>مرحبا ".$name."</h2>
            				<h3>يبدو انك نسيت كلمة السر الخاصة بك. لا تقلق !</h3>
            				<p style='text-align:center;'>
                                <a href='".$link."' style='border-radius: 5px;background: #ffc107; padding: 10px 15px;
                                display: inline-block;
                            color: #000;'>اعادة تعين كلمة السر</a>
                            </p>
                            <h3 style='margin: 45px 0px;
                            text-align: center;
                            font-weight: 400;'>انقر ادناه لأعادة تعين كلمة السر الخاصة بك</h3>
            			</div>
            		</td>
            	</tr>
            </table>
