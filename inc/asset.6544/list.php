        <?php $url_name_page = "https://".$_SERVER['HTTP_HOST']; ?>
                ...
                <?php if(isset($_SESSION['email_member']) && isset($_SESSION['password_member'])): ?>
                    ...
                    <div class="dropdown-toggle cairo position-relative text-decoration-none border-0 text-center d-block me-4 icon-navbar" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?= $url_name_page; ?>/assets/img/list_icon/loom_icon.png" style="width:35px;height: 37px;">
                        <span class="cairo me-1">حسابي</span>
                    </div>
